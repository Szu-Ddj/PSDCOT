...
class GraphConvolution(nn.Module):
    ...
    def __init__(self, in_features, out_features, bias=True):
        ...
        self.weight = nn.Parameter(torch.FloatTensor(in_features, out_features))        #将self.weight变成可训练的参数。将torch.FloatTensor(in_features, out_features)转化为parameter并绑定到这个模型
