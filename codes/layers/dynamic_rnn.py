...
class DynamicLSTM(nn.Module):
    ...
    def forward(self, x, x_len):
        ...
        """
        """sort"""
        x_sort_idx = torch.sort(-x_len)[1].long()           #返回倒序排列序号
        x_unsort_idx = torch.sort(x_sort_idx)[1].long()
        # print("x_sort_idx:",x_sort_idx, "x_unsort_idx:", x_unsort_idx)
        ...
        if self.rnn_type == 'LSTM': 
            ...
            # print(self.RNN(x_emb_p,None))
        else: 
            out_pack, ht = self.RNN(x_emb_p, None)
            ct = None
        """unsort: h"""
        # print("ht:",torch.transpose(ht,0,1))
